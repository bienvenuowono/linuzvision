...
export const metadata: Metadata = {
  ...
  title: {
    default: "LinuZvision | Sovereign AI, Cloud & Cybersecurity Architecture",
    template: "%s | LinuZvision",
  },
  description:
    "LinuZvision delivers sovereign AI systems (TASHA), turnkey datacenter engineering, zero-trust cybersecurity, and enterprise cloud infrastructure across America and Africa.",
  ...
  openGraph: {
    ...
    title: "LinuZvision | Sovereign AI, Cloud & Cybersecurity Architecture",
    description:
      "Sovereign AI systems, turnkey datacenter engineering, zero-trust cybersecurity, and enterprise cloud solutions across America and Africa.",
    images: [
      {
  ...
  twitter: {
    ...
    title: "LinuZvision | Sovereign AI, Cloud & Cybersecurity Architecture",
    description:
      "Sovereign AI systems, turnkey datacenter engineering, zero-trust cybersecurity, and enterprise cloud solutions.",
  ...
  const structuredData = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        name: "LinuZvision",
        description:
          "Sovereign AI, cloud computing, datacenter engineering, and cybersecurity architecture.",
