...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/images/linuzvision-logo-color.png", width: 1200, height: 430, alt: "LinuZvision LLC" }],
  },
  twitter: { card: "summary_large_image", title: "LinuZvision", description: "AI, automation and technology infrastructure across Africa and America.", images: ["/images/linuzvision-logo-color.png"] },
  robots: { index: true, follow: true, googleBot: { index: true, follow: true, "max-image-preview": "large", "max-snippet": -1, "max-video-preview": -1 } },
};

export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  const organization = { "@context": "https://schema.org", "@type": "Organization", name: "LinuZvision, LLC", url: process.env.NEXT_PUBLIC_SITE_URL || "http://localhost:3000", logo: "/images/linuzvision-logo-color.png", email: "linuzvisionllc@gmail.com", telephone: "+1-443-248-8520", areaServed: ["Africa", "United States"] };
  return (
    <html lang="en">
