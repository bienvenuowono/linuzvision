...
const services = [
  ...
  ["DATA SOVEREIGNTY", "Supporting regional requirements across America and Africa."],
];
const training = [
...
export function TrainingPage() {
  return <><Header active="TRAINING" /><main className="training-page">
    ...
    <section className="training-bridge shell"><div className="bridge-symbol">AMERICA <i /> AFRICA <i /> EUROPE</div><h2>AMERICA BRIDGE ↔ THE AFRICA ↔ EUROPE</h2><p>LinuZvision operates seamlessly across continents, providing organizations with localized expertise backed by global standards. We understand the nuanced infrastructure challenges and operational requirements in both regions.</p></section>
