...
const specializedAgents = [
  ["LEAD AGENT", "Qualifies requests and prepares the next commercial action."],
  ["CRM AGENT", "Reads and updates authorized customer relationship workflows."],
  ["INVOICE AGENT", "Create, processes, and routes invoices within approved business rules."],
    ...
    <>
      ...
      <main className="tasha-page">
        <section className="tasha-hero">
          ...
          <div className="shell tasha-hero-content">
            <div className="tasha-hero-grid">
              ...
              <div>
                <p>Tasha combines a conversational interface with an agentic intelligence core. It understands context, makes decision within approved bounderies, and coordinates specialized AI agents across business.</p>
        ...
        <section className="tasha-architecture shell" id="architecture">
          <div className="tasha-section-title"><h2>How Tasha works?</h2><p>Your architecture becomes a clear operating chain: one entry point, one reasoning core, specialized agents and connected business systems.</p></div>
          <div className="tasha-architecture-map" aria-label="TASHA architecture from user request to connected business systems">
            ...
            <div className="architecture-layer architecture-assistant"><span>CONVERSATIONAL ENTRY</span><h3>TASHA ASSISTANT</h3><p>recieces the request, maintains the conversation, and translates user intent into a structured task</p></div><i className="architecture-flow" aria-hidden="true" />
            <div className="architecture-layer architecture-core"><span>UNDERSTAND · DECIDE · ACT</span><h3>TASHA AGENTIC CORE</h3><p>interprets context, selects and approved course of action, delegates work, and tracks the result</p></div><i className="architecture-flow" aria-hidden="true" />
